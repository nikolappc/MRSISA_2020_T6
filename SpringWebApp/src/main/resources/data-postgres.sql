...
insert into administratori_klinike (adresa, broj_telefona, email, ime, jbo, password, prezime, id_klinike) values ('Godrics Hollow, London, UK', '066/125-112', 'dumbledore@gmail.com', 'Albus', '0221', 'albus12345', 'Dumbledore', 1);
...
insert into operacije (id, ime, id_sale, id_termina, id_tipa_posete, id_kartona, id_klinike) values (1, 'slepo crevo', 2, 3, 2, 3, 1);
insert into operacije (id, ime, id_sale, id_termina, id_tipa_posete, id_kartona, id_klinike) values (2, 'slepo crevo', 2, 3, 2, 2, 1);
